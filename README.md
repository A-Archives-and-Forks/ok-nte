...
> [!WARNING]
> 本软件是开源、免费的外部工具，仅供学习和交流使用。程序仅通过识别现有用户界面与游戏交互，不修改游戏文件或代码。
>
> 使用第三方工具可能违反《异环》官方规则并带来账号风险。请先阅读[《异环》公平游戏宣言](https://yh.wanmei.com/news/gamebroad/20260202/260701.html)，充分了解并自愿承担使用本工具的全部风险。

<details>
<summary>完整免责声明</summary>
